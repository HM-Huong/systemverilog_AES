...
module InvShiftRows (
	...
	always_comb
		begin
			...
			oState[112+:8] = iState[16+:8];
			oState[80+:8]  = iState[112+:8];
			oState[48+:8]  = iState[80+:8];
			oState[16+:8]  = iState[48+:8];
			...
			oState[96+:8] = iState[64+:8];
			oState[64+:8] = iState[32+:8];
			oState[32+:8] = iState[0+:8];
			oState[0+:8]  = iState[96+:8];
		end;
endmodule
